    ...
    <div>
      <Container style={{ marginTop: "15px" }} fluid>
        ...
        <Table className="mt-4">
          <thead>
            <tr>
              <th style={{ backgroundColor: '#3af710' }}>Title</th>
              <th style={{ backgroundColor: '#3af710' }}>Status</th>
              <th style={{ backgroundColor: '#3af710' }}>Pet</th>
              <th style={{ backgroundColor: '#3af710' }}>Sent To</th>
              <th style={{ backgroundColor: '#3af710' }}>Creation Date</th>
              <th style={{ backgroundColor: '#3af710' }}>Actions</th>
            </tr>
          </thead>
          <tbody>
            {filtered
