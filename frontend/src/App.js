...
import PetHotelRoomsList from "./clinicOwner/petHotelRoomsList/index"
import EditClinic from "./clinicOwner/clinicEdit"
import OwnerListClinicOwner from "./clinicOwner/ownersList"
import EditPetRoom from "./clinicOwner/petHotelRooms/petHotelRoomEdit"
    ...
    if (role === "CLINIC_OWNER") {
      vetRoutes = (
        <>
          ...
          <Route path="/petHotelRooms" exact={true} element={<PrivateRoute><PetHotelRoomsList /></PrivateRoute>} />
          <Route path="/clinics/:id" exact={true} element={<PrivateRoute><EditClinic /></PrivateRoute>} />
          <Route path="/petHotelRooms/:id" exact={true} element={<PrivateRoute><EditPetRoom /></PrivateRoute>} />
