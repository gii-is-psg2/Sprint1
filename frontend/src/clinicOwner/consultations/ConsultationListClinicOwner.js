        ...
        <div>
            <Container fluid style={{ marginTop: "15px" }}>
                ...
                <Table aria-label='consultations' className="mt-4">
                    <thead>
                        <tr>
                            <th style={{ backgroundColor: '#d3ac78' }}>Title</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Status</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Owner</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Pet</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Clinic</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Sent To</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Creation Date</th>
                            <th style={{ backgroundColor: '#d3ac78' }}>Actions</th>
                        </tr>
                    </thead>
