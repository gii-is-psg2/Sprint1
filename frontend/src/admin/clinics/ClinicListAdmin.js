      ...
      <div className="admin-page-container">
        ...
        <div>
          <Table aria-label="owners" className="mt-4">
            <thead>
              <tr>
                <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>Name</th>
                <th style={{ backgroundColor: '#d3ac78', width:"20%" }}>Address</th>
                <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>Telephone</th>
                <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>Clinic Owner</th>
                <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>Plan</th>
                <th style={{ backgroundColor: '#d3ac78', width:"20%" }}>Actions</th>
              </tr>
            </thead>
