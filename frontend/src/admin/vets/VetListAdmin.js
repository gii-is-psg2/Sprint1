        ...
        <Table aria-label="vets" className="mt-4">
          <thead>
            <tr>
              ...
              <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>City</th>
              <th style={{ backgroundColor: '#d3ac78', width:"20%" }}>Specialties</th>
              <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>Clinic</th>
              <th style={{ backgroundColor: '#d3ac78', width:"15%" }}>User</th>
