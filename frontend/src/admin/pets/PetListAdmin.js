      ...
      <div className="admin-page-container">
        ...
        <div>
          <Table aria-label="pets" className="mt-4">
            <thead>
              <tr>
                <th style={{ backgroundColor: '#d3ac78'}}>Name</th>
                <th style={{ backgroundColor: '#d3ac78'}}>Birth Date</th>
                <th style={{ backgroundColor: '#d3ac78'}}>Type</th>
                <th style={{ backgroundColor: '#d3ac78'}}>Owner</th>
                <th style={{ backgroundColor: '#d3ac78'}}>Visits</th>
